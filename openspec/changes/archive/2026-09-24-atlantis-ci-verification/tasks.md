...
- [x] 4.3 Archived the change via `openspec archive atlantis-ci-verification` on 2026-09-24 (pipeline #3165 green on 8ug8ear + blackhand per operator). `openspec/specs/ci-verification/spec.md` carries the 6 merged requirements + Purpose. Spec #2 in atlantis.
